        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Snackbar.make(view, "This is a Snackbar message", Snackbar.LENGTH_LONG)
                        .setAction("Click me", new View.OnClickListener() { // Set a action for the button in the Snackbar
                            @Override
                            public void onClick(View view) {
                                doSomething(); // Call a method that does something when the Snackbar button is clicked
                            }
