...
public class WidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context,
        ...
        for (int widgetId : appWidgetIds) {
            ...
            // Assign the PendingIntent to the Button
            // The result of this is when the user touches or clicks the button, that it
            // will recall the onUpdate method, and it will have an opportunity to update the widget
